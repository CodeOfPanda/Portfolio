...
export default function Container(props) {
  ...
  const meta = {
    ...
    description: `Software engineering student, lifetime learner, nature lover`,
    type: 'website',
    ...customMeta
  };
  ...
  return (
    <div className="bg-white dark:bg-black">
      <Head>
        ...
        <meta
          property="og:url"
          content={`https://maggieleigland.me${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://maggieleigland.me${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Maggie Leigland" />
